/**
 * @file    bsp_flash.c
 * @brief   Internal Flash BSP driver implementation (bare-metal, no FreeRTOS)
 */
...
uint32_t BspFlash_GetSectorSize(uint32_t sector_num)
{
    ...
    switch (sector_num)
    {
        case FLASH_SECTOR_0: return 16384u;
        case FLASH_SECTOR_1: return 16384u;
        case FLASH_SECTOR_2: return 16384u;
        case FLASH_SECTOR_3: return 16384u;
        case FLASH_SECTOR_4: return 65536u;
        case FLASH_SECTOR_5: return 131072u;
        case FLASH_SECTOR_6: return 131072u;
        case FLASH_SECTOR_7: return 131072u;
        default:             return 0;
    }
    // clang-format on
}
