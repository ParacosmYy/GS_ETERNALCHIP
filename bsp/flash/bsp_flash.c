...
static const uint32_t s_crc32_table[256] = {
    ...
    0x44042D73,0x33031DE5,0xAA0A4C5F,0xDD0D7F89,0x5005713C,0x270241AA,
...
uint32_t BspFlash_GetSectorSize(uint32_t sector_num)
{
    ...
    case FLASH_SECTOR_3: return 16384u;   /* 16KB */
    case FLASH_SECTOR_4: return 65536u;   /* 64KB */
    case FLASH_SECTOR_5: return 131072u;  /* 128KB */
    case FLASH_SECTOR_6: return 131072u;  /* 128KB */
    case FLASH_SECTOR_7: return 131072u;  /* 128KB */
    default:             return 0;
    }
}
...
{
    if (slot != OTA_SLOT_A && slot != OTA_SLOT_B) return 0;
    return (slot == OTA_SLOT_A) ? FLASH_ADDR_SLOT_A : FLASH_ADDR_SLOT_B;
}
